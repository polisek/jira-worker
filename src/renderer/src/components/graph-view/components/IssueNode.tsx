...
export function IssueNode({ data }: NodeProps) {
    ...
    const sprint =
        issue.fields.customfield_10020?.find((s) => s.state === "active") ?? issue.fields.customfield_10020?.[0]
        ...
        >
            ...
            <div className="flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                    {sprint && (
                        <span
                            className={`text-[9px] px-1.5 py-0.5 rounded border max-w-[64px] truncate shrink-0 ${
                                sprint.state === "active"
        ...
        return (
            <>
                ...
                <Handle
                    ...
                    id="top"
                    className={`${H} !bg-purple-500 !border-purple-400`}
                    title="Přidat úkol"
                />
                <Handle
                    type="target"
                ...
                <Handle type="source" position={Position.Top} id="top-src" className={G} />
                <Handle type="target" position={Position.Bottom} id="bottom-tgt" className={G} />
                <Handle type="target" position={Position.Left} id="left-parent-tgt" className={G} />
                <Handle type="target" position={Position.Right} id="right-parent-tgt" className={G} />
                {card}
            </>
        )
    }
    ...
    return (
        <>
            ...
            <Handle
                ...
                id="left-relates"
                style={{ top: "25%" }}
                className={`${H} !bg-blue-500 !border-blue-400`}
                title="Přijmout vazbu Souvisí"
            />
            <Handle
                type="target"
                position={Position.Left}
            ...
            <Handle
                ...
                id="left-blocks"
                style={{ top: "75%" }}
                className={`${H} !bg-red-500 !border-red-400`}
                title="Přijmout vazbu Blokuje"
            />
            <Handle
                type="source"
                position={Position.Left}
            ...
            <Handle
                ...
                style={{ top: "50%" }}
                className={`${H} !bg-purple-500 !border-purple-400`}
                title="Táhni: Nadřazený úkol"
            />
            <Handle type="source" position={Position.Left} id="left-blocks-src" style={{ top: "75%" }} className={G} />
